...
# If your program is run with exactly one argument (even if it is an empty string), 
# treat it as a person's name and print a greeting message. If it is run with zero arguments or more than one argument, 
